...
| **Core Features** | Emotion recognition, MiniPuzzle cognitive training |
| **ML Pipeline** | `/pipeline2` (emotion model)                 |
...
| **ML**    | Emotion model, inference    | `/pipeline2`      |
| **Shared**| Reusable components         | `/widgets`        |

**Rule:** NEVER mix UI and ML logic. Model calls live in services only.
...
```
AUDY/
├── lib/              # Flutter UI (screens, pages)
├── widgets/          # Reusable UI components
├── services/         # API wrappers, ML services, business logic
├── pipeline2/        # Emotion recognition model
└── AGENTS.md         # This file
```
...
| Colors                | Soft, low-stimulation palette      |
