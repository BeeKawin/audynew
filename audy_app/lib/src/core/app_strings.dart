...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _data = {
    ...
    'led_case_3': {'en': 'All blue', 'th': 'ไฟทั้งหมดสีน้ำเงิน'},
    'led_case_4': {'en': 'All yellow', 'th': 'ไฟทั้งหมดสีเหลือง'},
    'led_case_5': {'en': 'All cyan', 'th': 'ไฟทั้งหมดสีฟ้า'},
    'led_case_6': {'en': 'All magenta', 'th': 'ไฟทั้งหมดสีม่วงแดง'},
    'led_case_7': {'en': 'All white', 'th': 'ไฟทั้งหมดสีขาว'},
    'led_case_8': {
      'en': 'Red ears / Green arms / Blue tummy',
      'th': 'หูสีแดง / แขนสีเขียว / ท้องสีน้ำเงิน',
    },
    'led_case_9': {
      'en': 'Green ears / Blue arms / Yellow tummy',
      'th': 'หูสีเขียว / แขนสีน้ำเงิน / ท้องสีเหลือง',
    },
    'led_case_10': {
      'en': 'Blue ears / Yellow arms / Cyan tummy',
      'th': 'หูสีน้ำเงิน / แขนสีเหลือง / ท้องสีฟ้า',
    },
    'led_case_11': {
      'en': 'Yellow ears / Cyan arms / Magenta tummy',
      'th': 'หูสีเหลือง / แขนสีฟ้า / ท้องสีม่วงแดง',
    },
    'led_case_12': {
      'en': 'Cyan ears / Magenta arms / White tummy',
      'th': 'หูสีฟ้า / แขนสีม่วงแดง / ท้องสีขาว',
    },
    'led_case_13': {
      'en': 'Magenta ears / White arms / Red tummy',
      'th': 'หูสีม่วงแดง / แขนสีขาว / ท้องสีแดง',
    },
    'led_case_14': {
      'en': 'White ears / Red arms / Green tummy',
      'th': 'หูสีขาว / แขนสีแดง / ท้องสีเขียว',
    },
    'led_case_15': {
      'en': 'Split-color ears and arms',
      'th': 'หูและแขนแยกสีซ้ายขวา',
    },
    'led_case_16': {
      'en': 'Split-color ears / Magenta tummy',
      'th': 'หูแยกสี / ท้องสีม่วงแดง',
    },
    'led_case_17': {
      'en': 'Split-color ears only',
      'th': 'ไฟหูแยกสีเท่านั้น',
    },
    'led_case_18': {'en': 'Rainbow animation', 'th': 'ไฟสายรุ้ง'},
    'led_case_19': {'en': 'White tummy only', 'th': 'ไฟท้องสีขาวเท่านั้น'},
    'led_case_20': {'en': 'White nose only', 'th': 'ไฟจมูกสีขาวเท่านั้น'},
    'led_case_21': {'en': 'Cyan ears only', 'th': 'ไฟหูสีฟ้าเท่านั้น'},
    'led_case_22': {
