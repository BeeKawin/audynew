...
class ReadPronounceResultScreen extends StatefulWidget {
  ...
  @override
  State<ReadPronounceResultScreen> createState() =>
      _ReadPronounceResultScreenState();
}

class _ReadPronounceResultScreenState extends State<ReadPronounceResultScreen> {
  ...
  Future<void> _showCelebrationIfNeeded() async {
    ...
    final pointsEarned = widget.result.correctAttempts * 5;

    if (pointsEarned > 0) {
      // Calculate values BEFORE adding points
      final oldPoints = widget.controller.learningPoints;
      ...
      // Add points
      await widget.controller.addPoints(pointsEarned);
